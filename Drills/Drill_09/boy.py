...
# Boy Event
RIGHT_DOWN, LEFT_DOWN, RIGHT_UP, LEFT_UP, LSHIFT_DOWN, LSHIFT_UP , RSHIFT_DOWN, RSHIFT_UP, SLEEP_TIMER = range(9)
# fill here
...
class DashState:
    ...
    def do(boy):
        ...
        boy.timer -= 1
        if boy.boytimer > 1:
            boy.x += boy.velocity * boy.velocity2
            boy.boytimer -=1
        else:
            boy.x += boy.velocity
...
next_state_table = {
    ...
    DashState: {LSHIFT_DOWN: RunState, RSHIFT_DOWN: RunState,
